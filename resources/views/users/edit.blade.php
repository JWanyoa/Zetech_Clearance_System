        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <i class="fa fa-pencil-square"></i>
                    ...
                    <a href="{{route('users.index')}}" class="float-right btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i> Back</a>

                    <div class="float-right mr-2">
                        <form method="POST" action="{{route('users.destroy', $user->id)}}">
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Delete {{ $user->first_name }}?</button>
                        </form>
                    </div>
                </div>
